...
const CarDetails = () => {
  ...
  return car ? (
    <div className='px-6 md:px-24 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        className='lg:col-span-2'>
          ...
          className='space-y-6'>
            ...
            <hr className='border-bordorColor my-6' />
        ...
        onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          <p className='flex items-center justify-between text-2xl text-gray-800 font-normal'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div className='relative'>
              <input
                ...
                className='w-full border border-bordorColor px-3 py-2 rounded-lg pr-10'
                required
                id='pickup-date'
          ...
          {/* Total Amount */}
          {pickupDate && returnDate && totalAmount > 0 && (
