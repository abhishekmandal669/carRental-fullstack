...
const ManageCars = () => {
  ...
  const deleteCar = async (carId) => {
    try {
      ...
      const confirm = window.confirm('Are you sure you want to delte this car? ')
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      ...
      <Title title='Manage Cars' subTitle="View all listed car , update their details , or remove their from the booking platform"/>
      ...
      <div className='max-w-3xl w-full mt-6 rounded-md overflow-hidden border border-bordorColor'>
        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          ...
          <tbody>
            {cars.map((car, index) => (
              <tr key={index} className='border-t border-bordorColor'>
